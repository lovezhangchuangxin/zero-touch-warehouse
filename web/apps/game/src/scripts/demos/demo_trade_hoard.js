// M3 校准 · 囤货策略：三货物全做，深门低吸、宽波高抛，货架为主地面
// 为辅——资金沉淀在库存里等大波段。三策略对比之一
// （records/m3-calibration.md；地图 m3-trade）。
...
var GATE = {
  ...
  battery: { buy: 0.89, sell: 1.1 },
  chip: { buy: 0.84, sell: 1.13 },
};

var MARGIN = 1.06; // 卖出保底：bid ≥ 摊薄成本 × MARGIN
var MAX_OPEN = 3; // 并发在途订单上限
var RESERVE = 20; // 现金垫底（gold）
